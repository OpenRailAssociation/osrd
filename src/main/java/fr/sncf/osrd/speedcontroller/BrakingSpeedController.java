...
public final class BrakingSpeedController extends SpeedController {
    ...
    public String toString() {
        ...
        return String.format(
                "LimitAnnounceSpeedController { targetSpeed=%.3f, begin=%.3f, end=%.3f }",
