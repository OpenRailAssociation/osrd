 ...
 *
 * Basically adds constraints dynamically based on other inputs (like stopping before a square at an
 * intersection) Could be nice to have this be linkable to a chain of regulators in the future?
 */
