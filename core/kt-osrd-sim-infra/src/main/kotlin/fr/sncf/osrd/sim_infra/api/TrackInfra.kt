...
/**
 * A track chunk are internal subdivisions of track sections. These subdivisions are separated by
 * detectors.
 */
...
interface TrackInfra {
    @JvmName("getTrackSectionName") fun getTrackSectionName(trackSection: TrackSectionId): String
