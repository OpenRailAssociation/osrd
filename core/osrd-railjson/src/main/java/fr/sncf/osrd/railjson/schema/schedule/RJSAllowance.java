...
public class RJSAllowance {
    public static final PolymorphicJsonAdapterFactory<RJSAllowance> adapter = (PolymorphicJsonAdapterFactory.of(
                    RJSAllowance.class, "allowance_type")
    ...
    /**
     * An allowance which represents portions of the path where the train has to slow down in order
     * to avoid conflicts. Several can be applied by TrainSchedule, and they can overlap other
     * allowances.
     */
    ...
    /**
     * An allowance which will affect the whole path. It represents the additional time given to a
     * train to fulfill its schedule. Only one can be applied by TrainSchedule.
     */
    public static final class StandardAllowance extends RJSAllowance {
        ...
        public StandardAllowance(
                RJSAllowanceDistribution distribution, RJSAllowanceValue defaultValue, RJSAllowanceRange[] ranges) {
            this.distribution = distribution;
            this.defaultValue = defaultValue;
            this.ranges = ranges;
        }
