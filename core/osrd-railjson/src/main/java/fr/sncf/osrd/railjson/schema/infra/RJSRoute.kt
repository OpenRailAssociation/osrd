...
data class RJSRoute(
    ...
    @Json(name = "entry_point") val entryPoint: RJSWaypointRef<RJSTrainDetector>,
    @Json(name = "entry_point_direction") val entryPointDirection: EdgeDirection,
    @Json(name = "exit_point") val exitPoint: RJSWaypointRef<RJSTrainDetector>,
    ...
    constructor(
        id: String,
        entryPoint: RJSWaypointRef<RJSTrainDetector>,
        entryPointDirection: EdgeDirection,
        exitPoint: RJSWaypointRef<RJSTrainDetector>,
