...
/**
 * Nodes are points where two pieces of tracks connect. These points bear little to no information,
 * except maybe how the pieces of track were linked in the first place. Each TrackNode has two
 * DiTrackNode, one for each direction.
 */
