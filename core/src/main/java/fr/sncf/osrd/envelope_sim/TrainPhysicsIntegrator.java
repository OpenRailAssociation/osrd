...
public final class TrainPhysicsIntegrator {
    ...
    private IntegrationStep step(double timeStep, double position, double speed) {
        ...
        ArrayList<RJSRollingStock.EnergySource> EnergySources = RJSRollingStock.getEnergySources();
        ...
        /* Calcul extrait du excel
         *Calcul PBAT 1 =
         *SI(Pbus - Ppwp>0;
         *SI(SoC>Socmin; Pbus - Ppwp;SI(Pbus - Ppwp<0; Pbus - Ppwp;0))/Nconvbat     //Si Pbat>0
         *SI(SoC>Socmin; Pbus - Ppwp;SI(Pbus - Ppwp<0; Pbus - Ppwp;0))*Nconvbat)    //Si Pbat<=0
         *
         *PBAT=MIN(MaxPChargeBatterie;MAX(MinPChargeBatterie;SI(SoC<SoCMax; PBAT1;SI(PBAT1>0; PBAT1;0))))
         */
