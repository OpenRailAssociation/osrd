...
public class Pathfinding_algo<NodeT, EdgeT> {
    ...
    private record Step<EdgeT>(
        ...
        @Override
        public int compareTo(Step<EdgeT> o) {
            if (weight != o.weight)
    ...
    public static <NodeT, EdgeT> List<EdgeT> findEdgePath(
        ...
        return new Pathfinding_algo<>(graph, edgeToLength).runPathfindingEdgesOnly(locations);
    }
    ...
    public static <NodeT, EdgeT> List<EdgeRange<EdgeT>> findPath(
        ...
        return new Pathfinding_algo<>(graph, edgeToLength).runPathfinding(locations);
    }

    /** Constructor */
    private Pathfinding_algo(
            ImmutableNetwork<NodeT, EdgeT> graph,
            Function<EdgeT, Double> edgeToLength
    ) {
