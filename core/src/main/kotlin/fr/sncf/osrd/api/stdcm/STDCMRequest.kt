...
class STDCMRequest @JvmOverloads constructor(
    /**
     * Infra id
     */
    var infra: String,
    ...
    var maximumDepartureDelay = (3600 * 2).toDouble()
    ...
    var maximumRunTime: Double

    /**
     * Train category for speed limits
     */
    @Json(name = "speed_limit_tags")
    var speedLimitComposition: String? = null
    ...
    var standardAllowance: RJSAllowanceValue? = null
    /**
    ...
    companion object {
        val adapter: JsonAdapter<STDCMRequest> = Moshi.Builder()
