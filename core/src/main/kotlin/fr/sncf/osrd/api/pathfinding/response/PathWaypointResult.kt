...
class PathWaypointResult(
    ...
    fun isDuplicate(other: PathWaypointResult): Boolean {
        ...
        return if (!suggestion && !other.suggestion) false
        else abs(pathOffset - other.pathOffset) < 0.001
    }

    /** Merge a suggested with a give step */
    fun merge(other: PathWaypointResult) {
        suggestion = suggestion and other.suggestion
        if (!other.suggestion) return
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return if (other !is PathWaypointResult) false
        else
            id == other.id &&
    ...
    class PathWaypointLocation(
        ...
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
            return if (other !is PathWaypointLocation) false
            else trackSection == other.trackSection && offset.compareTo(other.offset) == 0
        }
