...
data class STDCMNode(
    ...
    val detector:
        DirDetectorId?, // Detector that separates the blocks, this is the physical location of the
    // node
    ...
    val locationOnBlock:
        PathfindingEdgeLocationId<
            Block
        >?, // Position on a block, if this node isn't on the transition between blocks
    // (stop)
