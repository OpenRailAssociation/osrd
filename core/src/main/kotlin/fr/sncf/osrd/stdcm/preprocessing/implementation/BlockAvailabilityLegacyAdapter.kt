...
class BlockAvailabilityLegacyAdapter(
    ...
    private fun getTimeTrainInBlock(
        ...
        val enterTime =
            envelopeStartTime + envelope.interpolateTotalTimeClamp(blockEnterOffset.meters)
        val exitTime =
            envelopeStartTime + envelope.interpolateTotalTimeClamp(blockExitOffset.meters)
