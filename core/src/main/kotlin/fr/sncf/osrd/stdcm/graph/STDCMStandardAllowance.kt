...
import fr.sncf.osrd.stdcm.graph.EnvelopeSimContextBuilder.build
import fr.sncf.osrd.stdcm.graph.STDCMUtils.makePathFromRanges
...
object STDCMStandardAllowance {
    private val logger: Logger = LoggerFactory.getLogger(STDCMStandardAllowance::class.java)
    ...
    fun applyAllowance(
        ...
        for (i in 0..9) {
            ...
            if (java.lang.Double.isNaN(conflictOffset))
                return newEnvelope
