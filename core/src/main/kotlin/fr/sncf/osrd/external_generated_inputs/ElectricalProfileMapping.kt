...
class ElectricalProfileMapping {
    ...
    fun getProfilesOnPath(infra: RawInfra, path: PathProperties): HashMap<String, DistanceRangeMap<String>> {
    ...
    fun getProfilesOnChunk(
        ...
        if (mapping.containsKey(trackName)) {
            ...
            profilesOnChunk = trackProfiles.subMap(
                chunkOffset.distance, chunkOffset.distance + infra.getTrackChunkLength(chunk).distance
            )
