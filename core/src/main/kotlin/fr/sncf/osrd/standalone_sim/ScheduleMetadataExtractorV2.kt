...
fun areScheduledPointsRespected(
    schedule: List<SimulationScheduleItem>,
...
fun makeSimpleReportTrain(
    ...
    val scheduledPointsHonored = areScheduledPointsRespected(schedule, envelopeStopWrapper)
...
/**
 * Generate path signals in envelope.
 * This doesn't generate path signals outside the envelope, because even if the train saw a red signal, it wouldn't
 * matter as the train was going to stop before it anyway.
 */
...
private fun pathSignalsInRange(
    pathOffsetBuilder: PathOffsetBuilder,
    blockPath: StaticIdxList<Block>,
    blockInfra: BlockInfra,
    rangeStart: Distance,
