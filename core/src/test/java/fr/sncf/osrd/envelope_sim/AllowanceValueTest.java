...
public class AllowanceValueTest {
    ...
    public void testFixedValue() {
        ...
        assertEquals(21, allowance.getAllowanceTime(Double.NaN, 50_000, 100_000));
    }

    @Test
    public void testPercentValue() {
        var allowance = new AllowanceValue.Percentage(42);
        assertEquals(42, allowance.getAllowanceTime(100, Double.NaN, Double.NaN), 0.01);
    }

    @Test
    public void testTimePerDistanceValue() {
        var allowance = new AllowanceValue.TimePerDistance(1);
        assertEquals(60, allowance.getAllowanceTime(Double.NaN, 100_000, 100_000), 0.01);
    }
}
