...
public class EnvelopeOverlayTest {
    ...
    void testMultipleOverlays() {
        ...
        var constSpeedEnvelope = Envelope.make(constSpeedPart);
        var builder = EnvelopeOverlayBuilder.forward(constSpeedEnvelope);
        builder.startContinuousOverlay(null, true, 0);
        assertFalse(builder.addStep(1, 1));
        assertTrue(builder.addStep(3, 2));

        builder.startContinuousOverlay(null, true, 6);
    ...
    void testSymmetricOverlay(boolean backwardDir) {
        ...
        builder.startContinuousOverlay(testMeta, true, overlayPoints[0]);
    ...
    void testBaseCurveSplit(boolean isBackward) {
        ...
        EnvelopeTestUtils.buildContinuous(builder, null, true, positions, speeds, isBackward);
        var envelope = builder.build();
    ...
    void testDiscontinuityOverlayEnd() {
        ...
        builder.startContinuousOverlay(null, true, 1);
        ...
        assertFalse(forwardEnvelope.physicallyAccurate);
    }
    ...
    void testLongOverlay(boolean reverse) {
        ...
        EnvelopeTestUtils.buildContinuous(builder, null, true, positions, speeds, reverse);
        var envelope = builder.build();
        assertEquals(4, envelope.size());
        assertTrue(envelope.physicallyAccurate);
    }
