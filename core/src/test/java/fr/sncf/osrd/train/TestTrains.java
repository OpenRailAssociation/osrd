...
public class TestTrains {
    ...
    private static Map<String, RollingStock.ModeEffortCurves> createModeEffortCurves(
        ...
        for (var entry : effortCurveConditions.entrySet()) {
            ...
            res.put(
                    mode,
                    new RollingStock.ModeEffortCurves(
                            isElectric,
    ...
    static {
        ...
        var linearModeEffortCurves = createModeEffortCurves(
                MAX_SPEED, CurveShape.LINEAR, Map.of("thermal", new RollingStock.EffortCurveConditions[0]));

        var complexModeEffortCurves = createModeEffortCurves(
                MAX_SPEED,
                CurveShape.LINEAR,
                Map.of(
                        "thermal",
                        ...
                        Lists.cartesianProduct(
                                ...
                                .map(triple -> new RollingStock.EffortCurveConditions(
                                        (Comfort) triple.get(0),
                                        triple.get(1).equals("null") ? null : (String) triple.get(1),
