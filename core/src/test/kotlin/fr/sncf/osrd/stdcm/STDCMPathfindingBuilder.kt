...
class STDCMPathfindingBuilder {
    // region NON-OPTIONAL
    private var infra: SignalingInfra? = null
    ...
    private var unavailableTimes: Multimap<SignalingRoute, OccupancyBlock> = ImmutableMultimap.of()
    ...
    fun setInfra(infra: SignalingInfra?): STDCMPathfindingBuilder {
        this.infra = infra
        return this
    }
    ...
    fun setStartLocations(startLocations: Set<EdgeLocation<SignalingRoute>>): STDCMPathfindingBuilder {
    ...
    fun setEndLocations(endLocations: Set<EdgeLocation<SignalingRoute>>): STDCMPathfindingBuilder {
    ...
    fun setUnavailableTimes(
        unavailableTimes: Multimap<SignalingRoute, OccupancyBlock>
    ...
    fun run(): STDCMResult? {
        ...
        return findPath(
            ...
            0.0,
            steps,
            RouteAvailabilityLegacyAdapter(unavailableTimes),
            timeStep,
            maxDepartureDelay,
            maxRunTime,
            tag,
