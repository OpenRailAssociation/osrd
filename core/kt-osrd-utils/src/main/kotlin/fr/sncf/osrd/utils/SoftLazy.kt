 ...
 *
 * Can also be used as a normal class, accessing the underlying object with `get`. This also gives
 * access to other methods, such as `reset`.
 */
