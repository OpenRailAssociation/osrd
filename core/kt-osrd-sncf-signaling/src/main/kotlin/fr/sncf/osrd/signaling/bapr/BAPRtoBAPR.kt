...
object BAPRtoBAPR : SignalDriver {
    ...
    private fun cascadePrimaryAspect(aspect: String): String {
        return when (aspect) {
            ...
            "S" -> "A"
            "C" -> "A"
            // this is only used for distant signals, which should only cascade on non-distant
            // signals,
            // which never display "Avertissement". Even though it should never happen in a valid
            // infrastructure,
