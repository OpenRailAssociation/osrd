...
public class AllowanceRangesTests {
    ...
    private Envelope makeSimpleMarecoEnvelopeWithRanges(
            EnvelopeSimContext context, double speed, boolean stop, AllowanceValue value1, AllowanceValue value2) {
    ...
    public void testRangesFlat() {
        ...
        var marecoEnvelope = makeSimpleMarecoEnvelopeWithRanges(
                testContext, 44.4, false, new AllowanceValue.Percentage(10), new AllowanceValue.Percentage(20));
        check(marecoEnvelope, INCREASING, CONSTANT, DECREASING, CONSTANT, DECREASING, DECREASING);
    ...
    public void testRangesOfDifferentTypes() {
        ...
        var ranges = List.of(
                new AllowanceRange(0, rangesTransition, value1), new AllowanceRange(rangesTransition, length, value2));
    ...
    public void testAllowanceRangeEdgeCase() {
        ...
        var ranges = List.of(new AllowanceRange(rangesTransitions[0], rangesTransitions[1], value1));
     ...
     * part, resulting in a linear allowance that goes faster. The transition can be weird.
     */
    @Test
    ...
    public void errorBuildupTest(int nRanges, int nStops) {
        ...
        for (int i = 0; i < nRanges; i++) {
            allowanceRanges.add(
                    new AllowanceRange(i * rangeLength, (i + 1) * rangeLength, new AllowanceValue.Percentage(50)));
        }

        var allowance = new LinearAllowance(0, testPath.getLength(), 1.5, allowanceRanges);
