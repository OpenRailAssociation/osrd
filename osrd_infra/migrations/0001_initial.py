    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.IntegerField(choices=[(0, 'Track Section'), (1, 'Track Section Link')])),
            ],
        ),
        migrations.CreateModel(
            name='Infra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='infra.identifier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='identifier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='infra.identifier'),
        ),
        migrations.AddField(
            model_name='tracksection',
            name='infra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entity_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='infra.entityid')),
                ('operational_point', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='infra.operationalpoint')),
