...
| services.editoast.cronjob | object | `{"env":[],"extend":"","labels":{},"schedule":"3 1 * * mon-fri"}` | cronjob configuration. Runs editoast gc |
...
| services.editoast.service_account_name | string, null | `nil` | Service account name associated to editoast pod |
| services.editoast.volumeMounts | array | `[]` | extra volumes mounts on editoast and stateful_editoast |
| services.editoast.volumes | array | `[]` | extra volumes to mount on editoast and stateful_editoast |
