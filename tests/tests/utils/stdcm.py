...
def add_train(editoast_url, scenario, start, stop, departure_time):
    path_id = run_pathfinding(editoast_url, scenario.infra, [start, stop])
    rolling_stock_id = _get_rolling_stock_id(editoast_url, "fast_rolling_stock")
