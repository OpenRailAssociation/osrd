...
fn create_functions(config: &Config) -> TokenStream {
    ...
    quote! {
        ...
        impl crate::models::Create for #model_name {
            async fn create_conn(self, conn: &mut crate::modelsv2::Connection) -> crate::error::Result<Self> {
                use #table::table;
            ...
            #[doc = #documentation]
            async fn create(self, db_pool: actix_web::web::Data<crate::modelsv2::ConnectionPool>) -> crate::error::Result<Self> {
...
fn retrieve_functions(config: &Config) -> TokenStream {
    ...
    quote! {
        ...
        impl crate::models::Retrieve for #model_name {
            async fn retrieve_conn(conn: &mut crate::modelsv2::Connection, obj_id: i64) -> crate::error::Result<Option<Self>> {
                use #table::table;
                use #table::dsl;
                use diesel_async::RunQueryDsl;
            ...
            async fn retrieve(db_pool: actix_web::web::Data<crate::modelsv2::ConnectionPool>, id: i64) -> crate::error::Result<Option<Self>> {
                let mut conn = db_pool.get().await?;
...
fn delete_functions(config: &Config) -> TokenStream {
    ...
    quote! {
        ...
        impl crate::models::Delete for #model_name {
            async fn delete_conn(conn: &mut crate::modelsv2::Connection, obj_id: i64) -> crate::error::Result<bool> {
                use #table::table;
                use #table::dsl;
                use diesel_async::RunQueryDsl;
            ...
            #[doc = #documentation]
            async fn delete(db_pool: actix_web::web::Data<crate::modelsv2::ConnectionPool>, id: i64) -> crate::error::Result<bool> {
                let mut conn = db_pool.get().await?;
...
fn update_functions(config: &Config) -> TokenStream {
    ...
    quote! {
        ...
        impl crate::models::Update for #model_name {
            async fn update_conn(self, conn: &mut crate::modelsv2::Connection, obj_id: i64) -> crate::error::Result<Option<Self>> {
                use #table::table;
            ...
            #[doc = #documentation]
            async fn update(self, db_pool: actix_web::web::Data<crate::modelsv2::ConnectionPool>, id: i64) -> crate::error::Result<Option<Self>> {
                let mut conn = db_pool.get().await?;
