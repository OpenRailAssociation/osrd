...
CREATE INDEX "search_operational_point_is_station" ON "search_operational_point" ("is_station");
...
AS $$
BEGIN
    INSERT INTO "search_operational_point" (id, obj_id, infra_id, uic, trigram, ci, ch, name, is_station)
    ...
    ((infra_object_operational_point.data->>'is_station')::boolean) AS is_station
...
BEGIN
    UPDATE "search_operational_point"
        ...
        "is_station" = ((infra_object_operational_point.data->>'is_station')::boolean)
        FROM (SELECT NEW.*) AS "infra_object_operational_point"
