...
impl PathfindingStep {
    ...
    /// Check if the step or a previous step is using the given track_node
...
fn compute_path(
    ...
    let successors = |step: &PathfindingStep| {
        ...
        // Check track_node not already used
