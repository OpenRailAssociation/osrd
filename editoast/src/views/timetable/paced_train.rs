    ...
    let all_occupancies: Vec<(String, TrackOccupancy)> = train_occurrences
        ...
        .flat_map(
            |((occurrence_id, train_schedule), (simulation, pathfinding))| {
                ...
                .into_iter()
                .map(
                    move |track_occupancy_utils::TrackOccupancy {
                              track_section,
                              time_begin,
                              duration,
                          }| {
...
mod tests {
    ...
    use core_client::fixtures::simulation_response;
    ...
    fn pathfinding_result_success() -> PathfindingResultSuccess {
        PathfindingResultSuccess {
            path: TrainPath {
                ...
                routes: vec![],
                track_section_ranges: vec![
                    TrackRange::new("TC1", 550000, 1000000), // Mid_West_station
                    TrackRange::new("TD0", 0, 14000000),     // Mid_East_station
                ],
            },
            length: 14450000,
