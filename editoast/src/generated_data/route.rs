...
impl GeneratedData for RouteLayer {
    ...
    fn update(
        ...
        let involved_objects =
            InvolvedObjects::from_operations(operations, infra_cache, ObjectType::Route);

        // Delete elements
        if !involved_objects.is_empty() {
            // We must delete both updated and deleted routes because we can only insert them and not update
