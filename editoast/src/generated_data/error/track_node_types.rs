...
/// Check unknown port name, duplicated group and unused port for track node type
...
mod tests {
    ...
    use crate::infra_cache::tests::{create_track_node_connection, create_track_node_type_cache};
    use crate::infra_cache::Graph;
