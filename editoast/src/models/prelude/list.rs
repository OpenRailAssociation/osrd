...
pub struct SelectionSettings<M: Model> {
    pub(in crate::models) filters: Vec<Arc<dyn Fn() -> FilterSetting<M> + Send + Sync>>,
    pub(in crate::models) sorts: Vec<Arc<dyn Fn() -> SortSetting<M> + Send + Sync>>,
    pub(in crate::models) limit: Option<i64>,
    pub(in crate::models) offset: Option<i64>,
    pub(in crate::models) paginate_counting: bool,
}
