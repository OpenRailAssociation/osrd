...
from osrd_infra.migrations import run_sql_complexe_add_foreign_key
...
class Migration(migrations.Migration):
    ...
    operations.append(
        migrations.RunSQL(
            sql=[(f"""ALTER TABLE osrd_infra_rollingstockimage
                    ALTER COLUMN "order" SET DEFAULT 0;
                """)],
            reverse_sql=[(f"""ALTER TABLE osrd_infra_rollingstockimage
    ...
    operations.append(migrations.RunSQL(
        sql=[(f"""ALTER TABLE osrd_infra_rollingstocklivery
            ...
            """)],
        reverse_sql=[(f"""ALTER TABLE osrd_infra_rollingstocklivery
    ...
    operations.append(run_sql_complexe_add_foreign_key(
