...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('osrd_infra', '0005_add_switch_label'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            """ALTER TABLE osrd_infra_switchlayer
                ADD infra_id INTEGER,
                ADD CONSTRAINT osrd_infra_switchlayer_fkey FOREIGN KEY (infra_id) REFERENCES osrd_infra_infra(id) ON DELETE CASCADE
            """,
            state_operations=[
                migrations.AddField(
