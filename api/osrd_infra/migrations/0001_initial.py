# Generated by Django 3.2.9 on 2022-03-18 16:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('infra', models.OneToOneField(to="osrd_infra.infra", on_delete=django.db.models.deletion.CASCADE, primary_key=True)),
            ],
        ),
        migrations.RemoveField(
            model_name="generatedinfra",
            name="infra",
        ),
        migrations.RunSQL(
            """ALTER TABLE osrd_infra_generatedinfra
                ADD infra_id INTEGER,
                ADD CONSTRAINT osrd_infra_generatedinfra_fkey FOREIGN KEY (infra_id) REFERENCES osrd_infra_infra(id) ON DELETE CASCADE,
                ADD CONSTRAINT osrd_infra_generatedinfra_pkey PRIMARY KEY (infra_id)
            """,
            state_operations=[
                migrations.AddField(
                    model_name="generatedinfra",
