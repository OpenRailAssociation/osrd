    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osrd_infra.pathmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.JSONField(validators=[osrd_infra.utils.JSONSchemaValidator(limit_value={'definitions': {'MultiLineString': {'description': 'MultiLineString Model', 'properties': {'coordinates': {'items': {'items': {'anyOf': [{'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 2, 'minItems': 2, 'type': 'array'}, {'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 3, 'minItems': 3, 'type': 'array'}]}, 'type': 'array'}, 'title': 'Coordinates', 'type': 'array'}, 'type': {'const': 'MultiLineString', 'title': 'Type', 'type': 'string'}}, 'required': ['coordinates'], 'title': 'MultiLineString', 'type': 'object'}, 'ObjectReference': {'properties': {'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'type': {'title': 'Type', 'type': 'string'}}, 'required': ['id', 'type'], 'title': 'ObjectReference', 'type': 'object'}}, 'properties': {'buffer_stops': {'items': {'$ref': '#/definitions/ObjectReference'}, 'title': 'Buffer Stops', 'type': 'array'}, 'detectors': {'items': {'$ref': '#/definitions/ObjectReference'}, 'title': 'Detectors', 'type': 'array'}, 'geo': {'$ref': '#/definitions/MultiLineString'}, 'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'sch': {'$ref': '#/definitions/MultiLineString'}}, 'required': ['geo', 'sch', 'id', 'detectors', 'buffer_stops'], 'title': 'TVDSection', 'type': 'object'})])),
                ('infra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osrd_infra.infra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('obj_id', models.CharField(max_length=255)),
                ('data', models.JSONField(validators=[osrd_infra.utils.JSONSchemaValidator(limit_value={'definitions': {'Direction': {'description': 'An enumeration.', 'enum': ['START_TO_STOP', 'STOP_TO_START'], 'title': 'Direction', 'type': 'string'}, 'ObjectReference': {'properties': {'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'type': {'title': 'Type', 'type': 'string'}}, 'required': ['id', 'type'], 'title': 'ObjectReference', 'type': 'object'}, 'Point': {'description': 'Point Model', 'properties': {'coordinates': {'anyOf': [{'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 2, 'minItems': 2, 'type': 'array'}, {'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 3, 'minItems': 3, 'type': 'array'}], 'title': 'Coordinates'}, 'type': {'const': 'Point', 'title': 'Type', 'type': 'string'}}, 'required': ['coordinates'], 'title': 'Point', 'type': 'object'}}, 'properties': {'angle': {'title': 'Angle', 'type': 'number'}, 'direction': {'$ref': '#/definitions/Direction'}, 'expr': {'title': 'Expr'}, 'geo': {'$ref': '#/definitions/Point'}, 'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'linked_detector': {'$ref': '#/definitions/ObjectReference'}, 'position': {'title': 'Position', 'type': 'number'}, 'sch': {'$ref': '#/definitions/Point'}, 'sight_distance': {'title': 'Sight Distance', 'type': 'number'}, 'track': {'$ref': '#/definitions/ObjectReference'}}, 'required': ['geo', 'sch', 'track', 'position', 'id', 'direction', 'sight_distance', 'angle'], 'title': 'Signal', 'type': 'object'})])),
                ('infra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osrd_infra.infra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('obj_id', models.CharField(max_length=255)),
                ('data', models.JSONField(validators=[osrd_infra.utils.JSONSchemaValidator(limit_value={'definitions': {'ApplicableDirections': {'description': 'An enumeration.', 'enum': ['START_TO_STOP', 'STOP_TO_START', 'BOTH'], 'title': 'ApplicableDirections', 'type': 'string'}, 'ObjectReference': {'properties': {'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'type': {'title': 'Type', 'type': 'string'}}, 'required': ['id', 'type'], 'title': 'ObjectReference', 'type': 'object'}, 'Point': {'description': 'Point Model', 'properties': {'coordinates': {'anyOf': [{'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 2, 'minItems': 2, 'type': 'array'}, {'items': [{'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}, {'anyOf': [{'type': 'number'}, {'type': 'integer'}]}], 'maxItems': 3, 'minItems': 3, 'type': 'array'}], 'title': 'Coordinates'}, 'type': {'const': 'Point', 'title': 'Type', 'type': 'string'}}, 'required': ['coordinates'], 'title': 'Point', 'type': 'object'}}, 'properties': {'applicable_directions': {'$ref': '#/definitions/ApplicableDirections'}, 'geo': {'$ref': '#/definitions/Point'}, 'id': {'maxLength': 255, 'title': 'Id', 'type': 'string'}, 'position': {'title': 'Position', 'type': 'number'}, 'sch': {'$ref': '#/definitions/Point'}, 'track': {'$ref': '#/definitions/ObjectReference'}}, 'required': ['geo', 'sch', 'track', 'position', 'id', 'applicable_directions'], 'title': 'Detector', 'type': 'object'})])),
                ('infra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='osrd_infra.infra')),
            ],
            options={
