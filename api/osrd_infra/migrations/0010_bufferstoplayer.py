# Generated by Django 3.2.9 on 2022-05-05 13:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            """ALTER TABLE osrd_infra_bufferstoplayer
                ADD infra_id INTEGER,
                ADD CONSTRAINT osrd_infra_bufferstoplayer_fkey FOREIGN KEY (infra_id) REFERENCES osrd_infra_infra(id) ON DELETE CASCADE
            """,
            state_operations=[
                migrations.AddField(
