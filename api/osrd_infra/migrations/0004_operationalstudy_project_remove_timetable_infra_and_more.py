        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("Started", "Started"), ("In progress", "InProgress"), ("Finish", "Finish")],
                        default="",
                        max_length=16,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("Time tables", "TimeTable"),
                            ("Flow rate", "FlowRate"),
                            ("Park sizing", "ParkSizing"),
                            ("Garage requirement bearings", "GarageRequirement"),
                            ("Operation or sizing of a maintenance centre or garage", "OperationOrSizing"),
                            ("Operability", "Operability"),
                            ("Strategic planning", "StrategicPlanning"),
                            ("Chart Stability", "ChartStability"),
                            ("Disturbance tests", "Disturbance"),
                        ],
                        default="",
                        max_length=100,
                    ),
