...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql=[
                """UPDATE osrd_infra_speedsectionmodel SET data['extensions']['psl_sncf'] = data['extensions']['lpv_sncf']""",
                """UPDATE osrd_infra_speedsectionmodel SET data['extensions'] = data['extensions'] - 'lpv_sncf'""",
            ],
            reverse_sql=[
                """UPDATE osrd_infra_speedsectionmodel SET data['extensions']['lpv_sncf'] = data['extensions']['psl_sncf']""",
