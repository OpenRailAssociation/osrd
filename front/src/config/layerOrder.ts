...
export const LAYERS = Object.freeze({
  ...
  LEVEL_CROSSINGS: { GROUP: LAYER_GROUPS.PUNCTUAL },
  SWITCHES: { GROUP: LAYER_GROUPS.PUNCTUAL },
  SIGNALS: { GROUP: LAYER_GROUPS.PUNCTUAL },
  MUTED_OPERATIONAL_POINTS: { GROUP: LAYER_GROUPS.PUNCTUAL },
  // 10 OVER PUNCTUAL
...
export const LAYER_ENTITIES_ORDERS: Record<Layer, number> = Object.freeze({
  ...
  level_crossings: LAYER_GROUPS_ORDER[LAYERS.LEVEL_CROSSINGS.GROUP],
  muted_operational_points: LAYER_GROUPS_ORDER[LAYERS.OPERATIONAL_POINTS.GROUP],
