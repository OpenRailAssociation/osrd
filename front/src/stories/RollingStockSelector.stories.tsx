...
export default {
  title: 'Common/RollingStockSelectorCard',
  component: RollingStockSelectorCard,
} as ComponentMeta<typeof RollingStockSelectorCard>;

const Template: ComponentStory<typeof RollingStockSelectorCard> = (args) => (
  <div className="w-50">
    <RollingStockSelectorCard {...args} />
  </div>
);
