...
import { cutSpaceTimeRect, batchFetch } from '../utils';
...
describe('batchFetch', () => {
  ...
  it('should fetch sequentially', async () => {
    ...
    batchFetch(['1', '2', '3', '4'], fetchSpy, { batchSize: 2, onComplete });
  ...
  it('should stop fetching once the abort function is called', async () => {
    ...
    const abort = batchFetch(['1', '2', '3', '4'], fetchSpy, { batchSize: 2, onComplete });
  ...
  it('should call onProgress after each batch, and onComplete on the end', async () => {
    ...
    batchFetch(['1', '2', '3', '4'], fetchSpy, { batchSize: 2, onProgress, onComplete });
  ...
  it('should call onError (and not call onComplete) when an error occurs', async () => {
    ...
    batchFetch(['1', '2'], fetchSpy, { onError, onComplete });
