...
import { receptionSignalToSignalBooleans, getTruncatedToSecondSchedule } from './utils';
...
> => {
  ...
  if (edit.field === 'receptionSignal') return receptionSignalToSignalBooleans(edit.value);
