...
export type CreateOperation = Operation & { operation_type: 'CREATE' };
export type UpdateOperation = Operation & { operation_type: 'UPDATE' };
export type DeleteOperation = Operation & { operation_type: 'DELETE' };
