  ...
  return (
    <>
      ...
      <div className="my-4 py-2 px-2" style={{ backgroundColor: 'white' }}>
        ...
        {signType === PSL_SIGN_TYPES.ANNOUNCEMENT && (
          <>
            ...
            <div className="my-2">
              <SelectImprovedSNCF
                sm
                title={t('Editor.tools.speed-edition.sign-type')}
                options={['TIV_B', 'TIV_D']}
                selectedValue={sign.type}
                onChange={() =>
                  updateSign(signInfo, {
                    ...sign,
        ...
        <div className="my-2">
          <SelectImprovedSNCF
            title={t('Editor.tools.speed-edition.sign-side')}
            sm
            options={['LEFT', 'RIGHT', 'CENTER']}
            onChange={(selectedValue) => updateSign(signInfo, { ...sign, side: selectedValue })}
            selectedValue={sign.side}
          />
        </div>
        <div className="mt-2">
