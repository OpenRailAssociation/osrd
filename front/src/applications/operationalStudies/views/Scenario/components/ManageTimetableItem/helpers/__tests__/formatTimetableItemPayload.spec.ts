    ...
    pathSteps: [
      {
        id: '0-0',
        location: {
          reference: { uic: 2, secondary_code: 'BV', trigram: 'WS' },
      ...
      },
      {
        id: '1-1',
        location: {
          reference: { uic: 6, secondary_code: 'BV', trigram: 'SS' },
          track_reference: null,
        },
        name: 'South_station',
        arrival: null,
  ...
  const rawTimetableItemToEditData: TimetableItemToEditData = {
    ...
    originalPacedTrain: {
      ...
      path: [
        {
          id: '0-0',
          location: { reference: { trigram: 'WS', secondary_code: 'BV' }, track_reference: null },
        },
        {
          id: '1-1',
          location: { reference: { trigram: 'SS', secondary_code: 'BV' }, track_reference: null },
        },
      ],
      power_restrictions: [],
      schedule: [],
        ...
        const userChanges: Partial<OperationalStudiesConfState> = {
          ...
          pathSteps: [
            rawOsrdconf.pathSteps[0],
            {
              id: '1-1',
              location: {
                reference: { trigram: 'SS', secondary_code: 'BV' },
                track_reference: null,
              },
              arrival: null,
