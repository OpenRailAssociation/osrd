    ...
    pathSteps: [
      {
        id: '0-0',
        location: {
          operational_point: { uic: 2, secondary_code: 'BV', trigram: 'WS' },
      ...
      },
      {
        id: '1-1',
        location: {
          operational_point: { uic: 6, secondary_code: 'BV', trigram: 'SS' },
          track_reference: null,
        },
        name: 'South_station',
        arrival: null,
    ...
    originalPacedTrain: {
      ...
      path: [
        ...
        },
        {
          id: '1-1',
          location: {
            operational_point: { trigram: 'SS', secondary_code: 'BV' },
            track_reference: null,
          },
        },
      ],
