...
export const trainSummaryTooFast: Extract<SimulationSummaryResult, { status: 'success' }> = {
  ...
  path_item_times_final: [{ arrival: 0 }, { arrival: 1739394 }, { arrival: 3069187 }],
  path_item_times_provisional: [{ arrival: 0 }, { arrival: 1834414 }, { arrival: 3164206 }],
  path_item_times_base: [{ arrival: 0 }, { arrival: 1444453 }, { arrival: 2491479 }],
...
> = {
  ...
  path_item_times_final: [{ arrival: 0 }, { arrival: 5280030 }, { arrival: 15300915 }],
  path_item_times_provisional: [{ arrival: 0 }, { arrival: 5222392 }, { arrival: 15267584 }],
  path_item_times_base: [{ arrival: 0 }, { arrival: 4730243 }, { arrival: 13828795 }],
  path_item_respect_times: [true, true, true],
...
export const trainSummaryNotHonored: Extract<SimulationSummaryResult, { status: 'success' }> = {
  ...
  path_item_times_final: [{ arrival: 0 }, { arrival: 1425534 }, { arrival: 2186885 }],
  path_item_times_provisional: [{ arrival: 0 }, { arrival: 1425534 }, { arrival: 2186885 }],
  path_item_times_base: [{ arrival: 0 }, { arrival: 1425534 }, { arrival: 2186885 }],
...
export const trainSummaryHonored: Extract<SimulationSummaryResult, { status: 'success' }> = {
  ...
  path_item_times_final: [{ arrival: 0 }, { arrival: 2186885 }],
  path_item_times_provisional: [{ arrival: 0 }, { arrival: 2186885 }],
  path_item_times_base: [{ arrival: 0 }, { arrival: 2186885 }],
