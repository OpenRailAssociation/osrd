  ...
  return (
    <>
      ...
      <div className="row no-gutters align-items-center">
        <div className="col-hdp-3 col-xl-4 col-lg-6">
          <div className="row no-gutters align-items-center">
            <div className="col-xl-4 col-5 small">{t('origin')}</div>
            <div className="font-weight-bold text-primary col-xl-8 col-7">
              {train[baseOrEco].stops[0].name || t('unknownStop')}
            </div>
          </div>
          <div className="row no-gutters align-items-center">
            <div className="col-xl-4 col-5 small">{t('destination')}</div>
            <div className="font-weight-bold text-primary col-xl-8 col-7">
              {train[baseOrEco].stops.at(-1)?.name || t('unknownStop')}
            </div>
          </div>
        </div>
        <div className="col-hdp-4 col-xl-4 col-lg-6 my-xl-0 my-1">
          <div className="row no-gutters align-items-center">
            <div className="col-4 col-xl-5 small">{t('rollingstock')}</div>
            <div className="font-weight-bold text-primary col-8 col-xl-7">{rollingStock.name}</div>
          </div>
          <div className="row no-gutters align-items-center">
            <div className="col-4 col-xl-5 small">{t('mass')}</div>
            <div className="font-weight-bold text-primary col-8 col-xl-7">
              {massWithOneDecimal(rollingStock.mass)}T
            </div>
          </div>
        </div>
        <div className="col-hdp-5 col-xl-4 col-lg-6">
          <div className="row no-gutters align-items-center">
            <div className="col-6 small">{t('composition')}</div>
            <div className="font-weight-bold text-primary col-6">{train.speed_limit_tags}</div>
          </div>
          <div className="row no-gutters align-items-center">
            <div className="col-6 small">{t('energydetails')}</div>
            <div
              className={cx(
