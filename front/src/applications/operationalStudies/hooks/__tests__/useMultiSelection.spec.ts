...
describe('useMultiSelection', () => {
  ...
  it('should set items and return them', async () => {
    const { result } = renderHook(() => useMultiSelection<TestItem>(deleteItemCallback));
  ...
  it('should toggle selection (add and remove items)', async () => {
    const { result } = renderHook(() => useMultiSelection<TestItem>(deleteItemCallback));
  ...
  it('should replace the selection when setSelectedItemIds is called', async () => {
    const { result } = renderHook(() => useMultiSelection<TestItem>(deleteItemCallback));
  ...
  it('should call deleteItemCallback for each selected id', async () => {
    const { result } = renderHook(() => useMultiSelection<TestItem>(deleteItemCallback));
  ...
  it('should not call deleteItemCallback with an empty selection', async () => {
    const { result } = renderHook(() => useMultiSelection<TestItem>(deleteItemCallback));
