    ...
    it('should return invalid fields with the default values', () => {
      ...
      const expected = {
        ...
        validRollingStockForm: {
          ...
          rollingResistanceA: { max: 20, min: 0, unit: 'kN/t', value: 0 },
          rollingResistanceB: { max: 0.5, min: 0, unit: 'kN/(km/h)/t', value: 0 },
          rollingResistanceC: { max: 0.01, min: 0, unit: 'kN/(km/h)²/t', value: 0 },
