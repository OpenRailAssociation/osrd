  ...
  return (
    <>
      ...
      >
        ...
        >
          {point.properties && Math.round(point.properties.speedTime.speed)}
          km/h
        </span>
        <span className="ml-2 small">
          {point.properties && datetime2time(point.properties.speedTime.time)}
        </span>
      </Marker>
      {point.properties.intermediaterMarkersPoints && point.properties.intermediaterMarkersPoints.map((intermediateMarkerPoint, i) => (
        <Marker
          className="map-search-marker"
