...
export type ComponentsSchemasTransformTimetableResponsePropertiesPacedTrainsItemsPropertiesCategoryOneOf1 =
    ...
    paced?: null | {
      exceptions: ({
        ...
        rolling_stock_category?: {
          value?: null | ComponentsSchemasTransformTimetableResponsePropertiesPacedTrainsItemsPropertiesCategoryOneOf1;
        };
        speed_limit_tag?: {
          value?: null | string;
        };
