...
export type PacedTrainException = {
  ...
  constraint_distribution?: ConstraintDistributionChangeGroup | null;
  disabled?: boolean;
  initial_speed?: InitialSpeedChangeGroup | null;
  /** Unique key for the exception within the paced train, required and generated by the frontend. */
  key: string;
  labels?: LabelsChangeGroup | null;
  options?: OptionsChangeGroup | null;
  path_and_schedule?: PathAndScheduleChangeGroup | null;
  rolling_stock?: RollingStockChangeGroup | null;
  rolling_stock_category?: RollingStockCategoryChangeGroup | null;
  speed_limit_tag?: SpeedLimitTagChangeGroup | null;
  start_time?: StartTimeChangeGroup | null;
  train_name?: TrainNameChangeGroup | null;
};
