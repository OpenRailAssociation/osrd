...
export default function SpeedLimits(props) {
  ...
  const speedValuePointParams = {
    ...
    layout: {
      ...
      'text-field': ['to-string', ['round', ['*', 3.6, ['get', 'speed_limit']]]],
      'text-size': 12,
  ...
  const speedValueParams = {
    ...
    layout: {
      ...
      'text-field': ['concat', ['round', ['*', 3.6, ['get', 'speed_limit']]], 'km/h'],
      'text-size': 9,
      'text-justify': 'left',
      'text-allow-overlap': false,
      'text-ignore-placement': false,
  ...
  const speedLineParams = {
    ...
    paint: {
      'line-color': ['case',
        ['all', ['>', ['round', ['*', 3.6, ['get', 'speed_limit']]], 220]], 'rgba(145, 211, 255, 1)',
        ['all', ['>', ['round', ['*', 3.6, ['get', 'speed_limit']]], 160], ['<=', ['to-number', ['get', 'speed_limit']], 220]], 'rgba(137, 247, 216, 1)',
        ['all', ['>=', ['round', ['*', 3.6, ['get', 'speed_limit']]], 140], ['<=', ['to-number', ['get', 'speed_limit']], 160]], 'rgba(158, 255, 119, 1)',
        ['all', ['>=', ['round', ['*', 3.6, ['get', 'speed_limit']]], 100], ['<', ['to-number', ['get', 'speed_limit']], 140]], 'rgba(224, 254, 100, 1)',
        ['all', ['>', ['round', ['*', 3.6, ['get', 'speed_limit']]], 60], ['<', ['to-number', ['get', 'speed_limit']], 100]], 'rgba(253, 244, 121, 1)',
        ['all', ['<=', ['round', ['*', 3.6, ['get', 'speed_limit']]], 60], ['>', ['to-number', ['get', 'speed_limit']], 30]], 'rgba(251, 178, 134, 1)',
        ['all', ['<=', ['round', ['*', 3.6, ['get', 'speed_limit']]], 30]], 'rgba(239, 81, 81, 1)',
        'rgba(185, 185, 185, 1)',
      ],
      'line-width': 4,
      'line-offset': 0,
