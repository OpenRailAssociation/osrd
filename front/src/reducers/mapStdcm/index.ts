...
// Action Types
export const UPDATE_VIEWPORT = 'mapStdcm/UPDATE_VIEWPORT';
export const UPDATE_TRANSFORM_REQUEST = 'mapStdcm/UPDATE_TRANSFORM_REQUEST';
export const UPDATE_MAPSTYLE = 'mapStdcm/UPDATE_MAPSTYLE';
export const UPDATE_MAP_TRACK_SOURCES = 'mapStdcm/UPDATE_MAP_TRACK_SOURCES';
export const UPDATE_MAP_SEARCH_MARKER = 'mapStdcm/UPDATE_MAP_SEARCH_MARKER';
export const UPDATE_SHOW_IGN_BD_ORTHO = 'mapStdcm/UPDATE_SHOW_IGN_BD_ORTHO';
export const UPDATE_SHOW_IGN_SCAN25 = 'mapStdcm/UPDATE_SHOW_IGN_SCAN25';
export const UPDATE_SHOW_IGN_CADASTRE = 'mapStdcm/UPDATE_SHOW_IGN_CADASTRE';
export const UPDATE_SHOW_OSM = 'mapStdcm/UPDATE_SHOW_OSM';
export const UPDATE_SHOW_OSM_TRACKSECTIONS = 'mapStdcm/UPDATE_SHOW_OSM_TRACKSECTIONS';
export const UPDATE_FEATURE_INFO_HOVER = 'mapStdcm/UPDATE_FEATURE_INFO_HOVER';
export const UPDATE_FEATURE_INFO_CLICK = 'mapStdcm/UPDATE_FEATURE_INFO_CLICK';
export const UPDATE_LAYERS_SETTINGS = 'osrdStdcmconf/UPDATE_LAYERS_SETTINGS';
export const UPDATE_SIGNALS_SETTINGS = 'osrdStdcmConf/UPDATE_SIGNALS_SETTINGS';
