...
// Action Types
export const UPDATE_MODE = 'osrdstdcmconf/UPDATE_MODE';
export const UPDATE_STDCM_MODE = 'osrdstdcmconf/UPDATE_STDCM_MODE';
export const UPDATE_NAME = 'osrdstdcmconf/UPDATE_NAME';
export const UPDATE_LABELS = 'osrdstdcmconf/UPDATE_LABELS';
export const UPDATE_PROJECT_ID = 'osrdstdcmconf/UPDATE_PROJECT_ID';
export const UPDATE_STUDY_ID = 'osrdstdcmconf/UPDATE_STUDY_ID';
export const UPDATE_SCENARIO_ID = 'osrdstdcmconf/UPDATE_SCENARIO_ID';
export const UPDATE_INFRA_ID = 'osrdstdcmconf/UPDATE_INFRA_ID';
export const UPDATE_SWITCH_TYPES = 'osrdstdcmconf/UPDATE_SWITCH_TYPES';
export const UPDATE_PATHFINDING_ID = 'osrdstdcmconf/UPDATE_PATHFINDING_ID';
export const UPDATE_TIMETABLE_ID = 'osrdstdcmconf/UPDATE_TIMETABLE_ID';
export const UPDATE_ROLLINGSTOCK_ID = 'osrdstdcmconf/UPDATE_ROLLINGSTOCK_ID';
export const UPDATE_ROLLINGSTOCK_COMFORT = 'osrdstdcmconf/UPDATE_ROLLINGSTOCK_COMFORT';
export const UPDATE_SPEED_LIMIT_BY_TAG = 'osrdstdcmconf/UPDATE_SPEED_LIMIT_BY_TAG';
export const UPDATE_ORIGIN = 'osrdstdcmconf/UPDATE_ORIGIN';
export const UPDATE_ORIGIN_SPEED = 'osrdstdcmconf/UPDATE_ORIGIN_SPEED';
export const UPDATE_ORIGIN_TIME = 'osrdstdcmconf/UPDATE_ORIGIN_TIME';
export const UPDATE_ORIGIN_DATE = 'osrdstdcmconf/UPDATE_ORIGIN_DATE';
export const UPDATE_ORIGIN_UPPER_BOUND_DATE = 'osrdstdcmconf/UPDATE_ORIGIN_UPPER_BOUND_DATE';
export const UPDATE_ORIGIN_UPPER_BOUND_TIME = 'osrdstdcmconf/UPDATE_ORIGIN_UPPER_BOUND_TIME';
export const TOGGLE_ORIGIN_LINKED_BOUNDS = 'osrdstdcmconf/TOGGLE_ORIGIN_LINKED_BOUNDS';
export const REPLACE_VIAS = 'osrdstdcmconf/REPLACE_VIAS';
export const UPDATE_VIAS = 'osrdstdcmconf/UPDATE_VIAS';
export const UPDATE_VIA_STOPTIME = 'osrdstdcmconf/UPDATE_VIA_STOPTIME';
export const PERMUTE_VIAS = 'osrdstdcmconf/PERMUTE_VIAS';
export const UPDATE_SUGGERED_VIAS = 'osrdstdcmconf/UPDATE_SUGGERED_VIAS';
export const DELETE_VIAS = 'osrdstdcmconf/DELETE_VIAS';
export const DELETE_ITINERARY = 'osrdstdcmconfDELETE_ITINERARY';
export const UPDATE_DESTINATION = 'osrdstdcmconf/UPDATE_DESTINATION';
export const UPDATE_DESTINATION_TIME = 'osrdstdcmconf/UPDATE_UPDATE_DESTINATION_TIME';
export const UPDATE_DESTINATION_DATE = 'osrdstdcmconf/UPDATE_UPDATE_DESTINATION_DATE';
export const UPDATE_TRAINCOMPO = 'osrdstdcmconf/UPDATE_TRAINCOMPO';
export const UPDATE_ITINERARY = 'osrdstdcmconf/UPDATE_ITINERARY';
export const UPDATE_FEATURE_INFO_CLICK_OSRD = 'osrdstdcmconf/UPDATE_FEATURE_INFO_CLICK_OSRD';
export const UPDATE_GRID_MARGIN_BEFORE = 'osrdstdcmconf/UPDATE_GRID_MARGIN_BEFORE';
export const UPDATE_GRID_MARGIN_AFTER = 'osrdstdcmconf/UPDATE_GRID_MARGIN_AFTER';
export const UPDATE_STANDARD_STDCM_ALLOWANCE = 'osrdstdcmconf/UPDATE_STANDARD_STDCM_ALLOWANCE';
