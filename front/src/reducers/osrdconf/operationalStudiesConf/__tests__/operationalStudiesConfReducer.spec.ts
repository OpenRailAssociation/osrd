...
const baseTimetableItemWithSummary: TimetableItemWithSummaries = {
  ...
  path: [
    { id: 'id1', location: { operational_point: { uic: 123 } } },
    { id: 'id2', location: { operational_point: { uic: 234 } } },
  ],
  speedLimitTag: 'MA100',
  labels: ['label1'],
