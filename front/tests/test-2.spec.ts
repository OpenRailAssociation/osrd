...
test('testing if all mandatory elements for configure a simulation are loaded in grilles horaires app', async ({
  page,
}) => {
  await page.goto('/');
  await page.getByText("Études d'exploitation").click();
