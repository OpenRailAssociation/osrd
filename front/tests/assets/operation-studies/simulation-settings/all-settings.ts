...
export const allSettingsData: TimesStopsTableRow[] = [
  {
    index: 1,
  ...
  },
  {
    ...
    trackName: 'V1',
    requestedArrival: '',
    calculatedArrival: '11:35:19',
    stopTime: '00h02m04s',
    requestedDeparture: '',
    calculatedDeparture: '11:37:23',
    signalReceptionClosed: false,
    shortSlipDistance: false,
    powerRestriction: '',
    margin: { requestedTheoretical: '', computedTheoretical: '', real: '', difference: '' },
  ...
  },
  {
    ...
    trackName: 'V1',
    requestedArrival: '',
    calculatedArrival: '11:49:43',
    stopTime: '00h00m00s',
    requestedDeparture: '',
    calculatedDeparture: '11:49:43',
    signalReceptionClosed: false,
    shortSlipDistance: false,
    powerRestriction: '',
    margin: { requestedTheoretical: '', computedTheoretical: '', real: '', difference: '' },
