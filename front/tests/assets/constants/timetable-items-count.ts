...
export const TOTAL_PACED_TRAINS = 5;
...
export const VALID_PACED_TRAINS = 4;
...
export const ROLLING_STOCK_FILTERED_ITEMS_EXCEPTION = 9;
...
const PACED_TRAINS_WITH_NO_SPEED_LIMIT_TAG = 3;
