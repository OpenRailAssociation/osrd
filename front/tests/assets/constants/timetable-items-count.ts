...
export const NAME_FILTERED_ITEMS_EXCEPTION = 1;
export const LABEL_FILTERED_ITEMS = 2;
export const LABEL_FILTERED_ITEMS_EXCEPTION = 1;
export const NAME_LABEL_FILTERED_ITEMS_MIXED = 3;
export const ROLLING_STOCK_FILTERED_ITEMS_EXCEPTION = 10;
