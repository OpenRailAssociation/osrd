...
test.describe('Rollingstock editor page', () => {
  ...
  test.beforeEach(async () => {
    ...
    uniqueDeletedRollingStockName = await generateUniqueName('Test_name_deleted');
  ...
  test('should correctly create a new rolling stock', async ({ page }) => {
    ...
    expect(rollingStockEditorPage.getToastSNCF).toBeVisible();
  ...
  test('should correctly duplicate and delete a rolling stock', async ({ page }) => {
    ...
    expect(rollingStockEditorPage.page.getByTestId(uniqueDeletedRollingStockName)).toBeHidden();
  });
});
