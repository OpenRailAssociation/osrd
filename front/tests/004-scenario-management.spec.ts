...
import { getProject, getStudy } from './utils/api-setup';
...
test.describe('Validate the Scenario creation workflow', () => {
  ...
  test.beforeAll('Fetch a project and a study ', async () => {
  ...
  test('Create a new scenario', async ({ page }) => {
    ...
    await scenarioPage.createOrUpdateScenario({
      name: scenarioName,
      description: scenarioData.description,
      infraName: 'small_infra_test_e2e',
      tags: scenarioData.tags,
      electricProfileName: 'small_infra',
    });
